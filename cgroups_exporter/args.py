...
parser.add_argument("-s", "--pool-size", type=int,
                    default=2, help="Thread pool size")
...
group.add_argument("--log-format", default="color",
...
group.add_argument("--collector-interval", type=float, default=15.)
group.add_argument("--collector-delay", type=float,
                   default=float(randint(1, 5)))
...
group.add_argument(
    "--profiler-top-results", type=int, required=False, default=20,
)

group = parser.add_argument_group("Memory tracer settings")
group.add_argument("--memory-tracer", action="store_true")
group.add_argument("--memory-tracer-interval", type=int,
                   required=False, default=5)
group.add_argument("--memory-tracer-top-results", type=int,
